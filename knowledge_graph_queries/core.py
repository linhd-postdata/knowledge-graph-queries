...
def get_scansion_old(uri):
    """DEPRECATED
    """
    query = QUERIES['scansion_graph'].replace('$', uri)
    print(query)
    conn = get_db()
    results = conn.graph(query, content_type=stardog.content_types.LD_JSON)
    json_ld_result = json.loads(results)
...
"""{
    ...
    "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#hasStanza": {
        "@embed": "@always",
        "@explicit":true,
        "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#metricalType": {},
        "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#rhymeScheme": {},
        "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#content": {},
        "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#stanzaNumber": {},
        "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#hasLine": {
            "@embed": "@always",
            "@explicit":true,
            "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#absoluteLineNumber": {},
            "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#relativeLineNumber": {},
            "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#content": {},
            "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#patterningMetricalScheme": {},
            "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#presentsRhyme": {
                "@explicit":true,
                "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#rhymeLabel": {}
            },
            "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#isCallLineIn": {
                "@explicit":true
            },
            "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#isEchoLineIn": {
                "@explicit":true
            },
            "http://postdata.linhd.uned.es/ontology/postdata-poeticAnalysis#isLineAffectedBy": {
                "@explicit":true
            },
